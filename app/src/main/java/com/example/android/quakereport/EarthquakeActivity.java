...
public class EarthquakeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.earthquakes_activity);

        ListView earthquakeListView = (ListView) findViewById(R.id.list);

        earthquakeListView.setEmptyView(findViewById(R.id.text_no_quake));
        ...
        // Verifica se tem conectividade com a internet
        ...
        if (activeNetwork != null && activeNetwork.isConnectedOrConnecting()) {
            ...
            TextView textView = (TextView) findViewById(R.id.text_no_quake);
